...
output_file = 'bounds_png/bounds_'.n.'_density_vs_time.png'
...
plot clients_count_file using 1:3 with linespoints ls 1 title "clients_count", \
	dist_x2_file using 1:3 with linespoints ls 2 title "dist_x2", \
	mst_file using 1:3 with linespoints ls 4 title "mst", \
	vc_file using 1:3 with linespoints ls 5 title "vc", \
	vc_mst_file using 1:3 with linespoints ls 6 title "vc_mst"
